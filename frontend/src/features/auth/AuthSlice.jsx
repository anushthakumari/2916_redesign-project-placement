	...
	extraReducers: (builder) => {
		builder
			...
			.addCase(loginStaffAsync.rejected, (state, action) => {
				state.status = "error";
				state.errors = action?.error?.response?.message
			...
			.addCase(loginStudentAsync.rejected, (state, action) => {
				state.status = "error";
				state.errors = state.errors = action?.error?.response?.message
					? action?.error?.response?.message
					: action.error.message;
			})
